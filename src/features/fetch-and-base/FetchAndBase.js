...
class FetchAndBase extends Component {
  ...
  render() {
    ...
    const image =
      this.props.base64 && !this.props.error ? <img src={this.props.base64} alt="" /> : null;
    ...
    return (
      <div>
        <Header as="h2">Fetch and base64</Header>
        {output}
        <Segment>
          ...
          <Button secondary disabled={false} onClick={this.handleExampleSource}>
            Get example unsplash source
          </Button>
        </Segment>
      </div>
    );
